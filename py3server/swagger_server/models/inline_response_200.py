...
class InlineResponse200(Model):
    ...
    def __init__(self, id: str=None, idmap: str=None, frequency: int=None):
        ...
        :type id: str
        :param idmap: The idmap of this InlineResponse200.
        :type idmap: str
    ...
    def idmap(self) -> str:
        """
        Gets the idmap of this InlineResponse200.
        The URL to execute the exactmatches API call on the id

        :return: The idmap of this InlineResponse200.
        :rtype: str
        """
        return self._idmap
    ...
    def idmap(self, idmap: str):
        """
        Sets the idmap of this InlineResponse200.
        The URL to execute the exactmatches API call on the id
